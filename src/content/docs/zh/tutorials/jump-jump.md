...
如果这些还不熟，先读 [零基础脚本入门](/zh/scripting/programming-primer/)、[脚本基础](/zh/scripting/basics/) 和 [生命周期与输入](/zh/scripting/lifecycle-input/)。如果你想先做一个更小的玩法闭环，可以先跟 [中间练习：做一个可玩的收集循环](/zh/tutorials/first-playable-loop/)。
